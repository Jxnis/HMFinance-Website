...
const { getSegSocialSimulatorPage, editSegSocialSimulator, getAllSimulatorsPage, getMaisValiasSimulatorPage, getIMTSimulatorsPage, editMaisValiasSimulator } = require('../../controllers/back-office/simulators-controller');
