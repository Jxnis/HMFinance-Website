	...
	en: {
		...
		Services: {
			...
			SubTitles: {
				...
				Company: '',
				Party: '',
				Others: 'Mailing Domiciliation, IRS Declaration, Independent Workers, and others'
			}
		},
		Simulators: {
			Title: 'Simulators',
	...
	pt: {
		...
		Services: {
			...
			Titles: {
				...
				Analytical: 'Contabilidade Analitica',
				Company: 'Constituição da Empresa',
				Party: 'Gestão de terceiros',
